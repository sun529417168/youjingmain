...
@VLayoutTag(R.layout.activity_download_play)
public class AYJDownLoadPlayActivity extends YJBaseActivity implements IVClickDelegate{
    @VViewTag(R.id.videobody)
    private V4PlaySkin v4PlaySkin;

    private LetvSimplePlayBoard playBoard;
    private Bundle bundle;
    private String TAG = "AYJDownLoadPlayActivity";
...
//        bundle = LetvParamsUtils.setVodParams("40ff268ca7".trim(), "6c658686bf".trim(), "", "151398", "", false);
        ...
        private void handlePlayState(int state, Bundle bundle) {
            switch (state) {
                case ISplayer.MEDIA_EVENT_PREPARE_COMPLETE:
                    ...
                    StringUtils.Log("1111111111111", "开始播放了");
                    uicontext.setVideoTitle("呵呵呵呵呵呵");
                    break;
                ...
                case ISplayer.PLAYER_EVENT_PAUSE:
                    if (player != null) {
                        StringUtils.Log("111111111111", "PLAYER_EVENT_PAUSE");
                    }
                    break;

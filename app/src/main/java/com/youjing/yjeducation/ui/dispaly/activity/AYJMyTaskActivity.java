...
public class AYJMyTaskActivity extends BaseSwipeBackActivity implements IVClickDelegate,YjGetUserInfo.UserCoin {
    ...
    protected void onLoadedView() {
        ...
        StringUtils.Log("AYJMyTaskActivity", "111111111111111111111111");
        getMyTask(true);
...
//                    startActivity(createIntent(YJMainActivity.class, createTransmitData(YJMainActivity.MAIN_POSITION, "1")));
    ...
    public void getMyTask(final boolean isOnlyinitData) {
                ...
                try {
                    ...
                    switch (json.getInt("code")) {
                        case 200:
                            ...
                            YJGlobal.setYjUser(null);
                            yjGetUserInfo.getUserCoinInfo(AYJMyTaskActivity.this);

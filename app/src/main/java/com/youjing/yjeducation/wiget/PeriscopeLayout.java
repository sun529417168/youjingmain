...
public class PeriscopeLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        drawables = new Drawable[7];
         red = getResources().getDrawable(R.mipmap.pl_heart_one);
        Drawable yellow = getResources().getDrawable(R.mipmap.pl_heart_two);
        Drawable blue = getResources().getDrawable(R.mipmap.pl_heart_three);
        Drawable four = getResources().getDrawable(R.mipmap.pl_heart_four);
        Drawable five = getResources().getDrawable(R.mipmap.pl_heart_five);
        Drawable six = getResources().getDrawable(R.mipmap.pl_heart_six);
        Drawable seven = getResources().getDrawable(R.mipmap.pl_heart_seven);
    ...
    public void addHeart() {
        ...
        dHeight = red.getIntrinsicHeight()*(random.nextInt(5)+8)/10;
        dWidth = dHeight;

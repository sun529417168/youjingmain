...
public class DecodeFormatManager {
  ...
  static public Collection<BarcodeFormat> PRODUCT_FORMATS;
  static public Collection<BarcodeFormat> ONE_D_FORMATS;
  static public Collection<BarcodeFormat> QR_CODE_FORMATS = EnumSet.of(BarcodeFormat.QR_CODE);
  static public Collection<BarcodeFormat> DATA_MATRIX_FORMATS = EnumSet.of(BarcodeFormat.DATA_MATRIX);
  static {

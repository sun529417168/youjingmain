...
import com.youjing.yjeducation.util.slidingmenuback.SlidingMenu;
import com.youjing.yjeducation.util.slidingmenuback.app.SlidingActivityHelper;


/**
 * 监听返回手势，往右滑动关闭当前页面的base
 * 孙腾腾
 * 创建时间：2016.7.27
 *
 * @return
 */
public abstract class BaseSwipeBackActivity extends YJBaseActivity implements SlidingMenu.OnOpenedListener {
